...
class _RotationScanScreenState extends State<RotationScanScreen> {
  ...
  Future<void> _createDraft() async {
    ...
    try {
      ...
      if (mounted) showErrorDialog(context, e, source: 'rotation-draft');
    }
  }
  ...
  Future<void> _finishScan() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        showErrorDialog(context, e, source: 'rotation-finish');
      }
    }
  }
  ...
  Future<void> _confirmDigit() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        showErrorDialog(context, e, source: 'rotation-confirm');
      }
    }
  }
